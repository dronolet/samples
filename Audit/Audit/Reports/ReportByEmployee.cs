...
{
    public class ReportByEmployee : ReportXls
    {
        ...
        public ReportByEmployee(DBCommonContext dbcontext, DateTime? dfrom, DateTime? dto, int userid) : base()
        {
        ...
        public void SetTitle()
        {
            ...
            AddEmptyRow();
            AddEmptyRow();
            SetCellValue(1, "Отчет по сотруднику", styles[0]);
            AddEmptyRow();
            SetCellValue(1, "Фамилия: " + _dbcontext.SprBudjetUsers.FirstOrDefault(o => o.Id == _userid).FullName, styles[0]);
            AddEmptyRow();
        ...
        {
            var list = _dbcontext.ReportSatistics.FromSql("GetReportSatistic @report, @dfrom, @dto, @emploee",
                  new SqlParameter("@report", 3),
                  new SqlParameter("@dfrom", _dfrom),
                  new SqlParameter("@dto", _dto),
                  new SqlParameter("@emploee", _userid)
