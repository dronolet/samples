...
{
    public class ReportAllEmploee : ReportXls
    {
        private DBCommonContext _dbcontext;
        private DateTime? _dfrom;
        private DateTime? _dto;

        public ReportAllEmploee(DBCommonContext dbcontext, DateTime? dfrom, DateTime? dto) : base()
        {
        ...
        public override void CreateStyles()
        {
            ...
            commonStyle.VerticalAlignment = VerticalAlignment.Center;
            commonStyle.Alignment = HorizontalAlignment.Center;
            //commonStyle.set setDataFormat(format.getFormat("0.0"));
            //commonStyle.DataFormat = 
            commonStyle.WrapText = true;
        ...
        public void SetTitle()
        {
            ...
            AddEmptyRow();
            AddEmptyRow();
            SetCellValue(1, "Отчет по сотрудникам", styles[0]);
            AddEmptyRow();
