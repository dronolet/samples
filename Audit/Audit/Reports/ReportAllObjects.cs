...
{
    public class ReportAllObjects : ReportXls
    {
        private DBCommonContext _dbcontext;
        private DateTime? _dfrom;
        private DateTime? _dto;

        public ReportAllObjects(DBCommonContext dbcontext, DateTime? dfrom, DateTime? dto) : base()
        {
        ...
        public void SetTitle()
        {
            ...
            AddEmptyRow();
            AddEmptyRow();
            SetCellValue(1, "Отчет по объектам", styles[0]);
            AddEmptyRow();
